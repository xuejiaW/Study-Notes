...
int main()
{
	...
	shader_Lamp.Use();
	glUniform3fv(glGetUniformLocation(shader_Lamp.Program, "lightColor"), 1, value_ptr(vec3(1, 1, 1)));
	shader_Cube.Use();
	glUniform3fv(glGetUniformLocation(shader_Cube.Program, "lightColor"), 1, value_ptr(vec3(1, 1, 1)));
	...
	glUniform3fv(glGetUniformLocation(shader_Cube.Program, "light.lightColor"), 1, value_ptr(lightColor));
	glUniform3fv(glGetUniformLocation(shader_Cube.Program, "light.lightPos"), 1, value_ptr(position[1]));
	glUniform3fv(glGetUniformLocation(shader_Cube.Program, "light.ambient"), 1, value_ptr(vec3(0.1f,0.1f,0.1f)));
	glUniform3fv(glGetUniformLocation(shader_Cube.Program, "light.diffuse"), 1, value_ptr(vec3(0.5f, 0.5f, 0.5f)));
	glUniform3fv(glGetUniformLocation(shader_Cube.Program, "light.specular"), 1, value_ptr(vec3(1, 1, 1)));
