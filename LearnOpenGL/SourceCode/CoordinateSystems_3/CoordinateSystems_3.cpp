...
int main()
{
	...
	Shader shader("E:/Learn/LearnOpenGL/SourceCode/CoordinateSystems_3/CoordinateSystems_3.vert"
		, "E:/Learn/LearnOpenGL/SourceCode/CoordinateSystems_3/CoordinateSystems_3.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//if we enable depth test,we must clear depth buffer every frame before render

		shader.Use();
		glm::mat4 trans;//每帧旋转
		trans = glm::rotate(trans, glm::radians(30.0f)*(GLfloat)glfwGetTime(), glm::vec3(0, 0, 1));
		...
		for (GLuint i = 0; i < 10; ++i)
		{
			...
			model = glm::rotate(model, i*glm::radians(-20.0f), glm::vec3(1, 0, 0));
